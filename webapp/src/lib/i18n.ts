...
export function translateServerError(message: string | null | undefined, fallback: string): string {
  ...
  const key = {
    ...
    'Invalid authenticator code': 'txt_server_error_invalid_authenticator_code',
    ...
    'Invalid token.': 'txt_server_error_invalid_authenticator_code',
    ...
    'User verification failed.': 'txt_master_password_verify_failed',
