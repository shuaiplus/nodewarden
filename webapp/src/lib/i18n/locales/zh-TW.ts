...
const zhTW: Record<string, string> = {
  ...
  "txt_recovery_code_used_two_step_disabled": "恢復代碼已使用成功，兩步驟驗證已關閉。請重新登入。",
  "txt_sign_in_again": "重新登入",
  "txt_two_step_verification_disabled": "兩步驟驗證已關閉",
  "txt_new_recovery_code": "新的恢復代碼",
  ...
  "txt_totp_rotate_intro": "設定新的驗證器：掃描此 QR Code，然後輸入它顯示的驗證碼。在你完成驗證之前，目前驗證器仍然有效。",
  "txt_server_error_invalid_authenticator_code": "驗證器驗證碼無效",
  "txt_enter_authenticator_code_to_disable": "請輸入驗證器驗證碼",
  "txt_change_authenticator": "更換驗證器",
  "txt_authenticator_code_or_recovery_code": "驗證器驗證碼或復原代碼",
  "txt_authenticator_changed": "驗證器已更換",
  "txt_manage_authenticator_app": "管理驗證器 App",
  "txt_manage_authenticator_choose_intro": "請選擇要對本帳戶的驗證器 App 執行的操作。",
  "txt_verify_current_second_factor_intro": "請輸入目前驗證器 App 產生的驗證碼，或輸入恢復碼。",
  "txt_totp_recovery_code_consumed_note": "本次更換使用了恢復碼，因此已產生新的恢復碼。請立即儲存：",
  "txt_totp_recovery_code_generated_note": "已產生新的恢復碼。請立即儲存：",
  "txt_totp_is_enabled_for_this_account": "此賬戶已啟用 TOTP。",
  "txt_total_items_count": "共 {count} 項",
  "txt_invalid_totp_secret": "該 TOTP 金鑰無效，請輸入驗證器 App 提供的 Base32 金鑰。",
  ...
  "txt_log_action_account_totp_rotate": "更換兩步驟登入金鑰",
