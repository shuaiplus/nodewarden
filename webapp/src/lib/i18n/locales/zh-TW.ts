...
const zhTW: Record<string, string> = {
  ...
  "txt_ga_migration_missing_pages": "仍需頁面：{pages}",
  "txt_ga_migration_duplicate_page": "該頁已收集。",
  "txt_ga_migration_batch_conflict": "該 QR 碼屬於另一次匯出。請先清除目前批次。",
  "txt_ga_migration_conflicting_page": "同一頁序號出現衝突內容。請清除批次後重試。",
  "txt_ga_migration_invalid_page": "無法讀取該遷移 QR 碼。",
  "txt_ga_migration_multiple_qr": "請選擇只包含一個 QR 碼的圖片。",
  "txt_ga_migration_incomplete": "匯入前請收集此次匯出的全部頁面。",
  "txt_ga_migration_over_limit": "此次匯出超出本機匯入上限。",
  "txt_ga_migration_ready": "頁面已全部收集。請在下方核對帳戶。",
  "txt_ga_migration_review_title": "核對帳戶",
  "txt_ga_migration_excluded_title": "已略過的帳戶",
  "txt_ga_migration_import_selected": "匯入所選",
  "txt_ga_migration_clear": "清除批次",
  "txt_ga_migration_empty_selection": "請至少選擇一個要匯入的帳戶。",
  "txt_ga_migration_page_label": "第 {index} 頁",
  "txt_ga_migration_config": "{algorithm}，{digits} 位",
  "txt_ga_migration_unnamed": "Authenticator",
  "txt_ga_migration_exclude_hotp": "不支援 HOTP",
  "txt_ga_migration_exclude_algorithm": "不支援的演算法",
  "txt_ga_migration_exclude_digits": "不支援的位數",
  "txt_ga_migration_exclude_type": "不支援的帳戶類型",
  "txt_ga_migration_exclude_secret": "缺少密鑰",
  "txt_ga_migration_exclude_malformed": "帳戶記錄格式無效",
  "txt_ga_migration_unknown_outcome": "匯入可能未完成。重試前請先檢查保險庫。",
  "txt_ga_migration_success": "已匯入 {count} 個驗證器帳戶。",
