...
const en: Record<string, string> = {
  ...
  "txt_recovery_code_used_two_step_disabled": "Your recovery code was used successfully and two-step verification has been disabled. Please sign in again.",
  "txt_sign_in_again": "Sign in again",
  "txt_two_step_verification_disabled": "Two-step verification disabled",
  "txt_new_recovery_code": "New recovery code",
  ...
  "txt_totp_rotate_intro": "Set up your new authenticator: scan this QR code, then enter the code it shows. Your current authenticator keeps working until the new one is verified.",
  "txt_server_error_invalid_authenticator_code": "That authenticator code is not valid",
  "txt_enter_authenticator_code_to_disable": "Enter your authenticator code",
  "txt_change_authenticator": "Change authenticator app",
  "txt_authenticator_code_or_recovery_code": "Authenticator code or recovery code",
  "txt_authenticator_changed": "Authenticator app changed",
  "txt_manage_authenticator_app": "Manage authenticator app",
  "txt_manage_authenticator_choose_intro": "Choose what to do with the authenticator app on this account.",
  "txt_verify_current_second_factor_intro": "Enter a code from your current authenticator app, or a recovery code.",
  "txt_totp_recovery_code_consumed_note": "A recovery code was used for this change, so a new one was generated. Save it now:",
  "txt_totp_recovery_code_generated_note": "A new recovery code was generated. Save it now:",
  "txt_totp_is_enabled_for_this_account": "TOTP is enabled for this account.",
  "txt_total_items_count": "{count} items",
  "txt_invalid_totp_secret": "That TOTP secret is not valid. Use a Base32 key from your authenticator app.",
  ...
  "txt_log_action_account_totp_rotate": "Change authenticator app",
