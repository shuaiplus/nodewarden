...
const en: Record<string, string> = {
  ...
  "txt_ga_migration_hint": "Scan or upload every Google Authenticator export QR page, then choose which accounts to import as new Login items.",
  "txt_ga_migration_scan_camera": "Scan migration QR",
  "txt_ga_migration_scan_page": "Scan or upload a migration QR page.",
  "txt_ga_migration_point_camera": "Point the camera at a Google Authenticator export QR code.",
  "txt_ga_migration_progress": "Collected {received} of {total} page(s).",
  "txt_ga_migration_missing_pages": "Still need page(s): {pages}",
  "txt_ga_migration_duplicate_page": "That page was already collected.",
  "txt_ga_migration_batch_conflict": "That QR belongs to a different export. Clear the current batch first.",
  "txt_ga_migration_conflicting_page": "A conflicting page was scanned for the same index. Clear the batch and start again.",
  "txt_ga_migration_invalid_page": "That migration QR could not be read.",
  "txt_ga_migration_multiple_qr": "Choose an image that contains exactly one QR code.",
  "txt_ga_migration_incomplete": "Collect every page from this export before importing.",
  "txt_ga_migration_over_limit": "This export exceeds the local import limit.",
  "txt_ga_migration_ready": "All pages collected. Review accounts below.",
  "txt_ga_migration_review_title": "Review accounts",
  "txt_ga_migration_excluded_title": "Skipped accounts",
  "txt_ga_migration_import_selected": "Import selected",
  "txt_ga_migration_clear": "Clear batch",
  "txt_ga_migration_empty_selection": "Select at least one account to import.",
  "txt_ga_migration_page_label": "Page {index}",
  "txt_ga_migration_config": "{algorithm}, {digits} digits",
  "txt_ga_migration_unnamed": "Authenticator",
  "txt_ga_migration_exclude_hotp": "HOTP is not supported",
  "txt_ga_migration_exclude_algorithm": "Unsupported algorithm",
  "txt_ga_migration_exclude_digits": "Unsupported digit count",
  "txt_ga_migration_exclude_type": "Unsupported account type",
  "txt_ga_migration_exclude_secret": "Missing secret",
  "txt_ga_migration_exclude_malformed": "Malformed account record",
  "txt_ga_migration_unknown_outcome": "Import may be incomplete. Check your vault before retrying.",
  "txt_ga_migration_success": "Imported {count} authenticator account(s).",
