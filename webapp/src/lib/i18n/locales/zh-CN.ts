...
const zhCN: Record<string, string> = {
  ...
  "txt_ga_migration_missing_pages": "仍需页面：{pages}",
  "txt_ga_migration_duplicate_page": "该页已收集。",
  "txt_ga_migration_batch_conflict": "该二维码属于另一次导出。请先清除当前批次。",
  "txt_ga_migration_conflicting_page": "同一页序号出现冲突内容。请清除批次后重试。",
  "txt_ga_migration_invalid_page": "无法读取该迁移二维码。",
  "txt_ga_migration_multiple_qr": "请选择只包含一个二维码的图片。",
  "txt_ga_migration_incomplete": "导入前请收集此次导出的全部页面。",
  "txt_ga_migration_over_limit": "此次导出超出本地导入上限。",
  "txt_ga_migration_ready": "页面已全部收集。请在下方核对账户。",
  "txt_ga_migration_review_title": "核对账户",
  "txt_ga_migration_excluded_title": "已跳过的账户",
  "txt_ga_migration_import_selected": "导入所选",
  "txt_ga_migration_clear": "清除批次",
  "txt_ga_migration_empty_selection": "请至少选择一个要导入的账户。",
  "txt_ga_migration_page_label": "第 {index} 页",
  "txt_ga_migration_config": "{algorithm}，{digits} 位",
  "txt_ga_migration_unnamed": "Authenticator",
  "txt_ga_migration_exclude_hotp": "不支持 HOTP",
  "txt_ga_migration_exclude_algorithm": "不支持的算法",
  "txt_ga_migration_exclude_digits": "不支持的位数",
  "txt_ga_migration_exclude_type": "不支持的账户类型",
  "txt_ga_migration_exclude_secret": "缺少密钥",
  "txt_ga_migration_exclude_malformed": "账户记录格式无效",
  "txt_ga_migration_unknown_outcome": "导入可能未完成。重试前请先检查保险库。",
  "txt_ga_migration_success": "已导入 {count} 个验证器账户。",
