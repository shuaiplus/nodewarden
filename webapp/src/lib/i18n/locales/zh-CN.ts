...
const zhCN: Record<string, string> = {
  ...
  "txt_recovery_code_used_two_step_disabled": "恢复代码已使用成功，两步验证已关闭。请重新登录。",
  "txt_sign_in_again": "重新登录",
  "txt_two_step_verification_disabled": "两步验证已关闭",
  "txt_new_recovery_code": "新的恢复代码",
  ...
  "txt_totp_rotate_intro": "设置新的验证器：扫描此二维码，然后输入它显示的验证码。在你完成验证之前，当前验证器仍然有效。",
  "txt_server_error_invalid_authenticator_code": "验证器验证码无效",
  "txt_enter_authenticator_code_to_disable": "请输入验证器验证码",
  "txt_change_authenticator": "更换验证器",
  "txt_authenticator_code_or_recovery_code": "验证器验证码或恢复代码",
  "txt_authenticator_changed": "验证器已更换",
  "txt_manage_authenticator_app": "管理验证器 App",
  "txt_manage_authenticator_choose_intro": "请选择要对本账户的验证器 App 执行的操作。",
  "txt_verify_current_second_factor_intro": "请输入当前验证器 App 生成的验证码，或输入恢复代码。",
  "txt_totp_recovery_code_consumed_note": "本次更换使用了恢复代码，因此已生成新的恢复代码。请立即保存：",
  "txt_totp_recovery_code_generated_note": "已生成新的恢复代码。请立即保存：",
  "txt_totp_is_enabled_for_this_account": "此账户已启用 TOTP。",
  "txt_total_items_count": "共 {count} 项",
  "txt_invalid_totp_secret": "该 TOTP 密钥无效，请输入验证器 App 提供的 Base32 密钥。",
  ...
  "txt_log_action_account_totp_rotate": "更换两步验证密钥",
