...
const es: Record<string, string> = {
  ...
  "txt_google_authenticator_migration": "Migración de Google Authenticator",
  "txt_ga_migration_hint": "Escanee o suba cada página QR de exportación de Google Authenticator y luego elija qué cuentas importar como nuevos inicios de sesión.",
  "txt_ga_migration_scan_camera": "Escanear QR de migración",
  "txt_ga_migration_scan_page": "Escanee o suba una página QR de migración.",
  "txt_ga_migration_point_camera": "Apunte la cámara a un código QR de exportación de Google Authenticator.",
  "txt_ga_migration_progress": "Se recopilaron {received} de {total} página(s).",
  "txt_ga_migration_missing_pages": "Aún faltan página(s): {pages}",
  "txt_ga_migration_duplicate_page": "Esa página ya se recopiló.",
  "txt_ga_migration_batch_conflict": "Ese QR pertenece a otra exportación. Borre primero el lote actual.",
  "txt_ga_migration_conflicting_page": "Se escaneó una página conflictiva para el mismo índice. Borre el lote y empiece de nuevo.",
  "txt_ga_migration_invalid_page": "No se pudo leer ese QR de migración.",
  "txt_ga_migration_multiple_qr": "Elija una imagen que contenga exactamente un código QR.",
  "txt_ga_migration_incomplete": "Recopile todas las páginas de esta exportación antes de importar.",
  "txt_ga_migration_over_limit": "Esta exportación supera el límite local de importación.",
  "txt_ga_migration_ready": "Todas las páginas recopiladas. Revise las cuentas abajo.",
  "txt_ga_migration_review_title": "Revisar cuentas",
  "txt_ga_migration_excluded_title": "Cuentas omitidas",
  "txt_ga_migration_import_selected": "Importar selección",
  "txt_ga_migration_clear": "Borrar lote",
  "txt_ga_migration_empty_selection": "Seleccione al menos una cuenta para importar.",
  "txt_ga_migration_page_label": "Página {index}",
  "txt_ga_migration_config": "{algorithm}, {digits} dígitos",
  "txt_ga_migration_unnamed": "Authenticator",
  "txt_ga_migration_exclude_hotp": "HOTP no es compatible",
  "txt_ga_migration_exclude_algorithm": "Algoritmo no compatible",
  "txt_ga_migration_exclude_digits": "Cantidad de dígitos no compatible",
  "txt_ga_migration_exclude_type": "Tipo de cuenta no compatible",
  "txt_ga_migration_exclude_secret": "Falta el secreto",
  "txt_ga_migration_exclude_malformed": "Registro de cuenta incorrecto",
  "txt_ga_migration_unknown_outcome": "La importación puede estar incompleta. Revise su bóveda antes de reintentar.",
  "txt_ga_migration_success": "Se importaron {count} cuenta(s) de autenticador.",
