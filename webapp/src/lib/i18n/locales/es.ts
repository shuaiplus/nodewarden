...
const es: Record<string, string> = {
  ...
  "txt_recovery_code_used_two_step_disabled": "Tu código de recuperación se usó correctamente y la verificación en dos pasos se ha desactivado. Inicia sesión de nuevo.",
  "txt_sign_in_again": "Iniciar sesión de nuevo",
  "txt_two_step_verification_disabled": "Verificación en dos pasos desactivada",
  "txt_new_recovery_code": "Nuevo código de recuperación",
  ...
  "txt_totp_rotate_intro": "Configura tu nuevo autenticador: escanea este código QR e introduce el código que muestre. Tu autenticador actual seguirá funcionando hasta que se verifique el nuevo.",
  "txt_server_error_invalid_authenticator_code": "El código del autenticador no es válido",
  "txt_enter_authenticator_code_to_disable": "Introduce tu código de autenticación",
  "txt_change_authenticator": "Cambiar aplicación de autenticación",
  "txt_authenticator_code_or_recovery_code": "Código de autenticación o código de recuperación",
  "txt_authenticator_changed": "Aplicación de autenticación cambiada",
  "txt_manage_authenticator_app": "Gestionar la aplicación de autenticación",
  "txt_manage_authenticator_choose_intro": "Elige qué hacer con la aplicación de autenticación de esta cuenta.",
  "txt_verify_current_second_factor_intro": "Introduce el código de tu aplicación de autenticación actual, o un código de recuperación.",
  "txt_totp_recovery_code_consumed_note": "Se usó un código de recuperación para este cambio, así que se generó uno nuevo. Guárdalo ahora:",
  "txt_totp_recovery_code_generated_note": "Se generó un nuevo código de recuperación. Guárdalo ahora:",
  "txt_totp_is_enabled_for_this_account": "TOTP está activado para esta cuenta.",
  "txt_total_items_count": "{count} elementos",
  "txt_invalid_totp_secret": "Ese secreto TOTP no es válido. Usa una clave Base32 de tu aplicación de autenticación.",
  ...
  "txt_log_action_account_totp_rotate": "Cambiar aplicación de autenticación",
