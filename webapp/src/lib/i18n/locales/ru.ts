...
const ru: Record<string, string> = {
  ...
  "txt_ga_migration_missing_pages": "Ещё нужны страницы: {pages}",
  "txt_ga_migration_duplicate_page": "Эта страница уже собрана.",
  "txt_ga_migration_batch_conflict": "Этот QR относится к другому экспорту. Сначала очистите текущий набор.",
  "txt_ga_migration_conflicting_page": "Для того же индекса отсканирована конфликтующая страница. Очистите набор и начните заново.",
  "txt_ga_migration_invalid_page": "Не удалось прочитать этот QR миграции.",
  "txt_ga_migration_multiple_qr": "Выберите изображение ровно с одним QR-кодом.",
  "txt_ga_migration_incomplete": "Соберите все страницы этого экспорта перед импортом.",
  "txt_ga_migration_over_limit": "Этот экспорт превышает локальный лимит импорта.",
  "txt_ga_migration_ready": "Все страницы собраны. Проверьте учётные записи ниже.",
  "txt_ga_migration_review_title": "Проверка учётных записей",
  "txt_ga_migration_excluded_title": "Пропущенные учётные записи",
  "txt_ga_migration_import_selected": "Импортировать выбранные",
  "txt_ga_migration_clear": "Очистить набор",
  "txt_ga_migration_empty_selection": "Выберите хотя бы одну учётную запись для импорта.",
  "txt_ga_migration_page_label": "Страница {index}",
  "txt_ga_migration_config": "{algorithm}, {digits} цифр",
  "txt_ga_migration_unnamed": "Authenticator",
  "txt_ga_migration_exclude_hotp": "HOTP не поддерживается",
  "txt_ga_migration_exclude_algorithm": "Неподдерживаемый алгоритм",
  "txt_ga_migration_exclude_digits": "Неподдерживаемое число цифр",
  "txt_ga_migration_exclude_type": "Неподдерживаемый тип учётной записи",
  "txt_ga_migration_exclude_secret": "Отсутствует секрет",
  "txt_ga_migration_exclude_malformed": "Некорректная запись учётной записи",
  "txt_ga_migration_unknown_outcome": "Импорт может быть неполным. Проверьте хранилище перед повтором.",
  "txt_ga_migration_success": "Импортировано учётных записей authenticator: {count}.",
