...
const ru: Record<string, string> = {
  ...
  "txt_recovery_code_used_two_step_disabled": "Код восстановления успешно использован, и двухэтапная проверка отключена. Войдите снова.",
  "txt_sign_in_again": "Войти снова",
  "txt_two_step_verification_disabled": "Двухэтапная проверка отключена",
  "txt_new_recovery_code": "Новый код восстановления",
  ...
  "txt_totp_rotate_intro": "Настройте новый аутентификатор: отсканируйте этот QR-код и введите показанный код. Текущий аутентификатор продолжит работать, пока новый не будет подтверждён.",
  "txt_server_error_invalid_authenticator_code": "Неверный код аутентификатора",
  "txt_enter_authenticator_code_to_disable": "Введите код аутентификатора",
  "txt_change_authenticator": "Сменить приложение-аутентификатор",
  "txt_authenticator_code_or_recovery_code": "Код аутентификатора или код восстановления",
  "txt_authenticator_changed": "Приложение-аутентификатор изменено",
  "txt_manage_authenticator_app": "Управление приложением-аутентификатором",
  "txt_manage_authenticator_choose_intro": "Выберите, что сделать с приложением-аутентификатором для этой учётной записи.",
  "txt_verify_current_second_factor_intro": "Введите код из текущего приложения-аутентификатора или код восстановления.",
  "txt_totp_recovery_code_consumed_note": "Для этого изменения использован код восстановления, поэтому создан новый. Сохраните его сейчас:",
  "txt_totp_recovery_code_generated_note": "Создан новый код восстановления. Сохраните его сейчас:",
  "txt_totp_is_enabled_for_this_account": "TOTP включен для этой учетной записи.",
  "txt_total_items_count": "{count} товаров",
  "txt_invalid_totp_secret": "Этот секрет TOTP недействителен. Используйте ключ Base32 из вашего приложения аутентификации.",
  ...
  "txt_log_action_account_totp_rotate": "Смена приложения-аутентификатора",
